...
def update_rule1_data(text, res):
    ...
    matching_index = find_matching_pair(text,0)
...
def update_rule1_mid(text, res):
    ...
    res['mid'] = parse_parentheses_with_offset(text[1 : matching_index],1)
...
def update_rule2_nodes(text, res):
    ...
    node_indices = [(0, matching_index)]

    while matching_index != len(text) - 1:
